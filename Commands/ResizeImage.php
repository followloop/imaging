...
namespace LOOP\Imaging\Commands;
...
/**
 * Class ResizeImage
 * @package LOOP\Imaging\Commands
 */
class ResizeImage extends Command
{
    protected $signature = 'imaging:resize {--image-id=} {--image-type=} {--sizes=}';
    ...
    {
        $this->localDisk = Storage::disk( config( 'imaging.local_disk_name', 'local' ) );
